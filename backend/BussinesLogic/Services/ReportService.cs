...
namespace BussinesLogic.Services
{
    public class ReportService : IReportService
    {
        ...
        public ReportService(IRepository<Booking> bookingRepository, IRepository<Hall> hallRepository, IReportExporterFactory exporterFactory)
        {
        ...
        public async Task<List<HallUsageReport>> GetHallUsageReport(ReportRequest reportRequest)
        {
        ...
        public async Task<string> ExportHallUsageReportToFile(ReportRequest reportRequest, ReportFormat format = ReportFormat.Csv)
        {
